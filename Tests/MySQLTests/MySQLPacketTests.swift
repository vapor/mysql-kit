...
class MySQLPacketTests: XCTestCase {
    func testHandshakeV10_wireshark() throws {
        ...
        let handshakeV10 = try MySQLHandshakeV10(bytes: &bytes, source: .capture())
        ...
        XCTAssertEqual(handshakeV10.capabilityFlags.CLIENT_PLUGIN_AUTH, true)
        XCTAssertEqual(handshakeV10.capabilityFlags.CLIENT_SECURE_CONNECTION, true)
    ...
    func testHandshakeV10_example1() throws {
        ...
        XCTAssertEqual(handshakeV10.capabilityFlags.CLIENT_PLUGIN_AUTH, true)
        XCTAssertEqual(handshakeV10.capabilityFlags.CLIENT_SECURE_CONNECTION, false)
        XCTAssertEqual(handshakeV10.characterSet, 8)
        XCTAssertEqual(handshakeV10.statusFlags, 2)
        XCTAssertEqual(handshakeV10.authPluginName, "*4d|cZwk4^]:")
    }
